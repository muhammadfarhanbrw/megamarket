...
//   try {
//     await dbConnect();
//     const deal = await TrendingDeal.findById(params.id).populate('productId', 'name price image');
...
//     const deal = await TrendingDeal.findByIdAndUpdate(
//       params.id,
//       updateData,
...
//   try {
//     await dbConnect();
//     const deal = await TrendingDeal.findByIdAndDelete(params.id);
